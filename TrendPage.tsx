...
const TrendPage: React.FC<TrendPageProps> = ({ onPlayShort, onPlayLong, excludedIds }) => {
  ...
  if (loading) return <div className="p-20 text-center"><div className="w-8 h-8 border-2 border-red-600 border-t-transparent rounded-full animate-spin mx-auto mb-4"></div><p className="text-red-500 font-bold">جاري تحديث الترند...</p></div>;
      ...
      <div className="flex items-center justify-between border-b border-red-600/20 pb-4">
        <div className="flex items-center gap-4">
           ...
           <div className="flex flex-col text-right">
              ...
              <p className="text-[9px] text-gray-500 font-bold uppercase tracking-widest">Viral Spirits Ranking</p>
           </div>
        </div>
      </div>
